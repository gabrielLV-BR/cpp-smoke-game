...
void Program::check_for_errors() {
  ...
  //     throw std::runtime_error("[ERROR] Error creating program! <INVALID_ENUM>");
  //     break;
  //   }
  //   case GL_INVALID_VALUE: {
  //     throw std::runtime_error("[ERROR] Error creating program! <INVALID_VALUE>");
  //     break;
  //   }
  //   case GL_INVALID_OPERATION: {
  //     throw std::runtime_error("[ERROR] Error creating program! <INVALID_OPERATION>");
  //     break;
  //   }
  //   case GL_OUT_OF_MEMORY: {
  //     throw std::runtime_error("[ERROR] Error creating program! <OUT_OF_MEMORY>");
  //     break;
  //   }
  //   case GL_INVALID_FRAMEBUFFER_OPERATION: {
  //     throw std::runtime_error("[ERROR] Error creating program! <INVALID_FRAMEBUFFER_OPERATION>");
  //     break;
  //   }
  //   default: {
